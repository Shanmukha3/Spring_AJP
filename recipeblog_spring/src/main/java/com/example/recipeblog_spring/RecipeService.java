...
public class RecipeService {
    ...
    public void start() {
        ...
        while (!exit) {
            ...
            System.out.println("4. Get Recipe by ID");
            System.out.println("5. Display All Recipes");
            System.out.println("6. Search Recipe by name");
    ...
    private void getsearchRecipes() {
        System.out.print("Enter recipe name you want to search: ");
        String searchName = scanner.next();
        boolean found = false;
        for (Recipe recipe : recipeDatabase.values()) {
            if (recipe.getName().equalsIgnoreCase(searchName)) {
                System.out.println("Recipe found:");
                System.out.println(recipe);
                found = true;
            }
        ...
        if (!found) {
            System.out.println("Recipe with Name \"" + searchName + "\" not found.");
        }
    }
    private void displayAllRecipes() {
        System.out.println("All Recipes:");
